...
const DEFAULT_VALUES = [
  {
    ...
    description: "We offer only authentic Samsung products.",
  ...
  },
  {
    ...
    description: "Over 50,000 satisfied customers.",
...
export async function generateMetadata() {
  ...
  return {
    ...
    description:
      ...
      "Learn about Samsung Phones Kenya - trusted for authentic Samsung smartphones and accessories.",
  };
}
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p
              ...
              dangerouslySetInnerHTML={{
                __html:
                  hero.subtitle ??
                  "Your trusted destination for authentic Samsung smartphones, tablets, wearables, and accessories in Kenya.",
              }}
            />
          </div>
        </div>
                ...
                {storyParagraphs.length > 0 ? (
                  ...
                  <>
                    <p>
                      ...
                      everyone across Kenya.
                    </p>
                    <p>
                      We understand the importance of technology in today&apos;s
                      world. Whether you&apos;re a professional, student, or
                      tech enthusiast, we believe everyone deserves access to
                      quality Samsung products.
                    </p>
                  </>
                )}
              </div>
              ...
              <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent flex items-end">
                <div className="p-8 text-white">
                  <div className="text-4xl font-bold mb-2">
                    {story.caption_title ?? "Since 2019"}
                  </div>
                  <div className="text-lg">
                    {story.caption_subtitle ?? "Serving Kenya with Excellence"}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              {values.section_subtitle ??
                "We're committed to providing the best shopping experience for Samsung products in Kenya"}
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {valueItems.map((value, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-linear-to-br ${value.color} rounded-2xl flex items-center justify-center mb-6`}
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-4">
                  {visit.directions_title ?? "Get Directions"}
                </h3>
                <p className="text-white/90 mb-6">
                  {visit.directions_text ??
                    "We're located in the heart of Westlands, easily accessible by public transport or car."}
                </p>
                <a
