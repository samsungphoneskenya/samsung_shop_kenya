        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-5 leading-tight">
              {hero.heading ? (
                hero.heading_highlight && hero.heading.includes(hero.heading_highlight) ? (
                  <>
                ...
                <>
                  Welcome to our <span className="text-black">Samsung</span> Online Store!
                </>
              )}
            </h1>
            ...
            <div className="relative">
              ...
              {(hero.badge_text || hero.badge_value) && (
                <div className="absolute -top-4 -right-4 bg-black text-white px-5 py-2.5 rounded-2xl shadow-xl transform rotate-6">
                  {hero.badge_text && (
                    <div className="text-xs font-semibold">{hero.badge_text}</div>
                  )}
                  {hero.badge_value && (
